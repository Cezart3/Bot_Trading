...
if "%choice%"=="1" (
    ...
    echo.
    python backtests\run_backtest_stocks.py --symbol AMD --days 30
    goto end
)
...
if "%choice%"=="2" (
    ...
    echo.
    python backtests\run_backtest_stocks.py --symbol AMD --days 60 --live-data
    goto end
)
...
if "%choice%"=="3" (
    ...
    echo.
    python backtests\run_backtest_stocks.py --all-stocks --days 30
    goto end
)
