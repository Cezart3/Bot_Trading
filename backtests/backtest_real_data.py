...
class RealDataBacktester:
    ...
    def run_backtest(self, days: int = 60) -> Optional[BacktestResult]:
        ...
        print(f"  M1: {len(m1_candles)}, M5: {len(m5_candles)}, H1: {len(h1_candles)}, H4: {len(h4_candles)}, D1: {len(daily_candles)}")
...
def run_real_backtest(
    ...
    print("=" * 70)
    print("SMC V3 BACKTEST - REAL MT5 DATA")
    print("=" * 70)
    ...
    print("-" * 70)
    print(f"{'TOTAL':<10} {total_trades:<8} {'-':<8} {'-':<8} ${total_pnl:<11,.2f}")
    print("=" * 70)
